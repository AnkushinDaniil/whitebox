...
export const ui = {
  en: {
    ...
    hub: {
      eyebrow: "The evergreen spine",
      h1: "The Execution Layer, explained",
      lede: "A structured path through Ethereum's execution layer, written once and built to last. Each entry is a self-contained explorable: one mechanism, one live widget, layered from intuition to spec. Follow it in order, or drop into whatever you came to understand.",
  ...
  ru: {
    ...
    hub: {
      eyebrow: "Вечнозелёная основа",
      h1: "Исполнительный слой: объяснение",
      lede: "Структурированный путь по исполнительному слою Ethereum, написанный один раз и надолго. Каждая запись — самостоятельный разбор: один механизм, один живой виджет, со слоями от интуиции до спецификации. Идите по порядку или сразу открывайте то, ради чего пришли.",
