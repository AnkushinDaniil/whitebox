...
export const FORKS: Fork[] = [
  ...
  },
  {
    ...
    eips: [
      ...
      { eip: "1014", title: "CREATE2", category: "execution" },
  ...
  },
  {
    ...
    eips: [
      ...
      { eip: "3855", title: "PUSH0 instruction", category: "execution" },
  ...
  },
  {
    ...
    eips: [
      ...
      { eip: "6780", title: "SELFDESTRUCT only same-tx", category: "execution" },
